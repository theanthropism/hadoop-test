...
public class TestHdfs {
    ...
    @Test
    public void stuTest(){
        String address = "经纬城市绿洲小区108楼1单元1301室";
        String xq = "小区";
        String lou = "楼";
        String dy = "单元";
        System.out.println(address.substring(address.indexOf(xq)+xq.length(),address.lastIndexOf(lou)));

        System.out.println(address.substring(address.indexOf(lou)+lou.length(),address.lastIndexOf(dy)));
    }
}
